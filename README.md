...
**当前版本**：v1.2.0 | [发布说明](docs/RELEASE-v1.1.0.md) | [桌面测试版下载](https://github.com/webmturn/ai-localization/releases/tag/v1.1.0)
...
| 引擎 | 类型 | 批量翻译 | 备注 |
|------|------|----------|------|
| **DeepSeek** | AI | ✅ JSON 模式 | 默认引擎，性价比高 |
| **OpenAI** | AI | ✅ JSON 模式 | GPT-4o / GPT-4o-mini |
| **Gemini** | AI | ✅ JSON 模式 | 免费层 15 RPM，自动限速 |
