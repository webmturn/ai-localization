...
3. **模块专用错误处理器**
   - `public/app/features/translations/error-handler.js` - 翻译模块
   - `public/app/services/storage/error-handler.js` - 存储模块
   - `public/app/network/error-handler.js` - 网络模块
   - `public/app/features/files/error-handler.js` - 文件处理模块
